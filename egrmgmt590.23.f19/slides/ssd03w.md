...
title: 03w Getting Around Linux
...
- Guess what? SSH is another hybrid protocol that provides authentication and encryption
...
- Connect somewhere: `openssl s_client -connect www.google.com:443`

- Shows protocol version, cipher suite, certificates, etc.

- Tons of command-line options for using specific protocol versions, cipher suites, etc.
...
- Get your web server running first

- You can get a certificate however you want, but _Let's Encrypt_ worked for me: https://letsencrypt.org/

- You have to install something called `certbot` on your server

 - Just follow the instructions

- Then you have to put a magic number in a magic place, served up by your web server

- If everything lines up, `certbot` gets the private key and certificate and saves it on your server

- Then configure your server to use the key and certificate
